...
#for thresh in np.arange(0, 0.05, 0.01):
for thresh in [0.05]:
    for name in names:
        qid2hint = {}
        ...
        print(f"Dumping to {name + '_vqx_random_hint_for_some.pkl'}")
        pickle.dump(qid2hint, open(name + f'_vqx_random_hint_for_{thresh}.pkl', 'wb'))
